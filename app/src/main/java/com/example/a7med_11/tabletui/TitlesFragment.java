package com.example.a7med_11.tabletui;
...
/**
 * Created by a7med_11 on 30/01/16.
 */
public class TitlesFragment extends ListFragment {// True or False depending on if we are in horizontal or duel pane mode
    boolean mDuelPane;
